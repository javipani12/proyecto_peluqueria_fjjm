        ...
        return Scaffold(
            ...
            body: Column(
              children: [
                  ...
                  onChanged: (value) {
                    ...
                    setState(() {
                      if (sliderEnable) {
                        ...
                        for (int i = 0;
                            i < peluquerosServices.peluqueros.length;
                            i++) {
                          peluquerosSeleccionados
                              .add(peluquerosServices.peluqueros[i]);
                        }
                      } else {
                        peluquerosSeleccionados.clear();
                      }
                ...
                Text(mostrarPeluquerosSeleccionados(peluquerosSeleccionados)),
                SizedBox(
                  height: 20,
                ),
                ElevatedButton(
                  ...
                  onPressed: () {
                    if (peluquerosSeleccionados.length == 0) {
                      ...
                      variablesGlobales.info['peluqueros'] =
                          peluquerosSeleccionados;
