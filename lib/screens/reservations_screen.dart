...
class _ReservationsScreenState extends State<ReservationsScreen> {
  ...
  SingleChildScrollView reserva(BuildContext context, ReservasServices reservasServices) {
    int contador = 0;
            ...
            itemBuilder: (BuildContext context, int index) {
              ...
              return Container(
                child: reserva.idUsuario == variablesGlobales.usuario.id! && !reserva.eliminado
                            ...
                            children: [
                              ...
                              ListTile(
                                ...
                                trailing: CancelButton(
                                  onPressed: () {
                                    displayDialog(context, reserva, reservasServices, actualizarPantalla);
                                  },
                                ),
                              ),
                            ],
                  ...
                  : contador == 0 && index == reservasServices.reservas.length - 1
                    ? const Image(
...
void displayDialog(BuildContext context, Reserva reserva, ReservasServices reservasServices, Function actualizarVentana) {
  showDialog(
    context: context,
    builder: (context) {
      return AlertDialog(
